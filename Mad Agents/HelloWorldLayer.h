...
CCSprite *mainCharacterBlueBoyStandingStillHoldingSomething;
CCSprite *mainCharacterBlueBoyJumpingHoldingSomething;
CCSprite *mainCharacterBlueBoyWalkingWithSneakersHoldingSomething;
CCSprite *mainCharacterBlueBoyStandingStillWithSneakersHoldingSomething;
CCSprite *mainCharacterBlueBoyJumpingWithSneakersHoldingSomething;
NSMutableArray *firstPlayerSpritesArray;
CCAction *fastInvincibilityRainbowAction;
CCAction *slowInvincibilityRainbowAction;
BOOL fastInvincibilityRainbowActionRunning;
BOOL slowInvincibilityRainbowActionRunning;
CCAction *shakeGameLayerForNuclearExplosion;

CCSprite *bossEnemySpawnPointHoleInWall;
CCSprite *whiteTeleportationSphere;
CCSprite *blackLayerForPauseScreen;
CCSprite *jumpButtonPressed;
CCSprite *activePowerUpButtonPressed;
CCSprite *dPadNotPressed;
CCSprite *dPadLeft;
CCSprite *dPadRight;
