...
{
 //   NSLog (@"makHidgonJumpMethod running");
                ...
                if (isPlayer1) {
                    ...
                    if ([[self.hidgonMovementsArray lastObject] intValue] == 0 && !self.hidgonCurrentlyJumping) {
                       ...
                       // [(HelloWorldLayer*)theGame sendMakeHidgonShootFireballLeft: self.enemyReferenceNumber];
                        ...
                        [self runAction: [CCSequence actions: [CCDelayTime actionWithDuration:0.75], [CCCallFunc actionWithTarget:self selector:@selector(sendMessageMakeHidgonShootFireballLeftMethod)], nil]];
                    }
                      ...
                      //  [(HelloWorldLayer*)theGame sendMakeHidgonShootFireballRight: self.enemyReferenceNumber];
                        ...
                        [self runAction: [CCSequence actions: [CCDelayTime actionWithDuration:0.75], [CCCallFunc actionWithTarget:self selector:@selector(sendMessageMakeHidgonShootFireballRightMethod)], nil]];
                    }
        ...
        if (globalEnemyType == HIDGON_ENEMY_TYPE) {
            ...
            */
            ...
            if (helloWorldIsBoss == YES) {
                ...
                isBoss = YES;
                gunnerStandingStill.scale = 1.4;
                gunnerStunned.scale = 1.4;
                gunnerWalking.scale = 1.4;
            }
       ...
       // NSLog (@"walkingSpeed = %f", walkingSpeed);
        ...
        if (self.stunTimeValue > 0) {
            ...
            if (self.enemyType == PARKOUR_JUMPER_TYPE) {
                ...
                ninjaJumping.color = ccBLUE;
                ninjaRunning.color = ccBLUE;
                ninjaStandingStill.color = ccBLUE;
                ninjaStunned.color = ccBLUE;
            }
            
            if (self.enemyType == HIDGON_ENEMY_TYPE) {
                
                gunnerWalking.color = ccBLUE;
                gunnerStandingStill.color = ccBLUE;
                gunnerStunned.color = ccBLUE;
            }
            
            if (self.enemyType == SKELETON_WHALE_TYPE) {
                
                jetmanFlying.color = ccBLUE;
                jetmanStunned.color = ccBLUE;
            }
            
            if (self.enemyType == DIAGONAL_FLYER_TYPE) {
                
                flyingDownLeft.color = ccBLUE;
                flyingDownRight.color = ccBLUE;
                flyingUpLeft.color = ccBLUE;
                flyingUpRight.color = ccBLUE;
            ...
            if (self.enemyType == CHASER_ENEMY_TYPE) {
                ...
                chaserWalking.color = ccBLUE;
                chaserRunning.color = ccBLUE;
                ...
                chaserStandingStillBored.color = ccBLUE;
                chaserStandingStillAngry.color = ccBLUE;
            }
            
            if (self.enemyType == DOWNWARD_SHOOTER_TYPE) {
                
                saucerFlying.color = ccBLUE;
                saucerStunned.color = ccBLUE;
            }
        }
