...
#define FIRST_PLAYER_INVINCIBLE                 NO
#define SECOND_PLAYER_INVINCIBLE                NO
...
int firstPlayerSpriteHeadCollisionHeight = 9;
...
-(void) addFirstPlayerSprite: (float)x y:(float)y
{
    ...
    CCSpriteBatchNode *spriteSheetMainCharacterBlueBoyWalkingWithSneakers;
    if (playerColorAndGender == BLUE_BOY)
    //create the sprite sheet
   ...
   /*
    //Starting here, integration of Green Boy with NO Sneakers
    //pass in the name of the property list
    //pass in the name of the property list
    [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile: @"MainCharacterGreenBoy.plist"];
    
    //create the sprite sheet
    CCSpriteBatchNode *spriteSheetMainCharacterGreenBoyWalking = [CCSpriteBatchNode batchNodeWithFile: @"MainCharacterGreenBoy.png"];
    [self addChild: spriteSheetMainCharacterGreenBoyWalking z: 150];
    
    //Create array of cairostance frames
    NSMutableArray *mainCharacterGreenBoyWalkingAnimFrames = [NSMutableArray array];
    for(int i = 2; i <= 5; ++i) {
        [mainCharacterGreenBoyWalkingAnimFrames addObject: [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName: [NSString stringWithFormat:@"MainCharacterGreenBoy%d.png", i]]];
    }
    
    //Create the animation object
    CCAnimation *mainCharacterGreenBoyWalkingAnim = [CCAnimation animationWithFrames:mainCharacterGreenBoyWalkingAnimFrames delay:0.08f];
    
    //Create sprite and run the animation
    mainCharacterGreenBoyWalking = [CCSprite spriteWithSpriteFrameName:@"MainCharacterGreenBoy2.png"];
    mainCharacterGreenBoyWalking.anchorPoint = ccp(0.5, 0.4);
    CCAction *mainCharacterGreenBoyWalkingAction = [CCRepeatForever actionWithAction:[CCAnimate actionWithAnimation: mainCharacterGreenBoyWalkingAnim restoreOriginalFrame:NO]];
    [mainCharacterGreenBoyWalking runAction: mainCharacterGreenBoyWalkingAction];
    mainCharacterGreenBoyWalking.visible = NO;
    mainCharacterGreenBoyWalking.position = ccp(x, y);
    
    
    mainCharacterGreenBoyStandingStill = [CCSprite spriteWithSpriteFrameName:@"MainCharacterGreenBoy1.png"];
    mainCharacterGreenBoyStandingStill.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterGreenBoyStandingStill z:25];
    mainCharacterGreenBoyStandingStill.position = ccp(x, y);
    mainCharacterGreenBoyStandingStill.visible = NO;
    
    mainCharacterGreenBoyJumping = [CCSprite spriteWithSpriteFrameName:@"MainCharacterGreenBoy9.png"];
    mainCharacterGreenBoyJumping.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterGreenBoyJumping z:25];
    mainCharacterGreenBoyJumping.position = ccp(x, y);
    mainCharacterGreenBoyJumping.visible = NO;
    
    mainCharacterGreenBoyDead = [CCSprite spriteWithSpriteFrameName:@"MainCharacterGreenBoy6.png"];
    mainCharacterGreenBoyDead.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterGreenBoyDead z:25];
    mainCharacterGreenBoyDead.position = ccp(x, y);
    mainCharacterGreenBoyDead.visible = NO;
    
    mainCharacterGreenBoyHoldingUpBoxingGlove = [CCSprite spriteWithSpriteFrameName:@"MainCharacterGreenBoy10.png"];
    mainCharacterGreenBoyHoldingUpBoxingGlove.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterGreenBoyHoldingUpBoxingGlove z:25];
    mainCharacterGreenBoyHoldingUpBoxingGlove.position = ccp(x, y);
    mainCharacterGreenBoyHoldingUpBoxingGlove.visible = NO;
    
    [spriteSheetMainCharacterGreenBoyWalking addChild: mainCharacterGreenBoyWalking z:25];
    

    
    //Starting here, integration of Green Boy WITH Sneakers
    //pass in the name of the property list
    //pass in the name of the property list
    [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile: @"MainCharacterGreenBoyWithSneakers.plist"];
    
    //create the sprite sheet
    CCSpriteBatchNode *spriteSheetMainCharacterGreenBoyWalkingWithSneakers = [CCSpriteBatchNode batchNodeWithFile: @"MainCharacterGreenBoyWithSneakers.png"];
    [self addChild: spriteSheetMainCharacterGreenBoyWalkingWithSneakers z: 150];
    
    //Create array of cairostance frames
    NSMutableArray *mainCharacterGreenBoyWalkingWithSneakersAnimFrames = [NSMutableArray array];
    for(int i = 2; i <= 5; ++i) {
        [mainCharacterGreenBoyWalkingWithSneakersAnimFrames addObject: [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName: [NSString stringWithFormat:@"MainCharacterGreenBoyWithSneakers%d.png", i]]];
    }
    
    //Create the animation object
    CCAnimation *mainCharacterGreenBoyWalkingWithSneakersAnim = [CCAnimation animationWithFrames:mainCharacterGreenBoyWalkingWithSneakersAnimFrames delay:0.08f];
    
    //Create sprite and run the animation
    mainCharacterGreenBoyWalkingWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterGreenBoyWithSneakers2.png"];
    mainCharacterGreenBoyWalkingWithSneakers.anchorPoint = ccp(0.5, 0.4);
    CCAction *mainCharacterGreenBoyWalkingWithSneakersAction = [CCRepeatForever actionWithAction:[CCAnimate actionWithAnimation: mainCharacterGreenBoyWalkingWithSneakersAnim restoreOriginalFrame:NO]];
    [mainCharacterGreenBoyWalkingWithSneakers runAction: mainCharacterGreenBoyWalkingWithSneakersAction];
    mainCharacterGreenBoyWalkingWithSneakers.visible = NO;
    mainCharacterGreenBoyWalkingWithSneakers.position = ccp(x, y);
    
    
    mainCharacterGreenBoyStandingStillWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterGreenBoyWithSneakers1.png"];
    mainCharacterGreenBoyStandingStillWithSneakers.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterGreenBoyStandingStillWithSneakers z:25];
    mainCharacterGreenBoyStandingStillWithSneakers.position = ccp(x, y);
    mainCharacterGreenBoyStandingStillWithSneakers.visible = NO;
    
    mainCharacterGreenBoyJumpingWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterGreenBoyWithSneakers9.png"];
    mainCharacterGreenBoyJumpingWithSneakers.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterGreenBoyJumpingWithSneakers z:25];
    mainCharacterGreenBoyJumpingWithSneakers.position = ccp(x, y);
    mainCharacterGreenBoyJumpingWithSneakers.visible = NO;
    
    mainCharacterGreenBoyDeadWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterGreenBoyWithSneakers6.png"];
    mainCharacterGreenBoyDeadWithSneakers.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterGreenBoyDeadWithSneakers z:25];
    mainCharacterGreenBoyDeadWithSneakers.position = ccp(x, y);
    mainCharacterGreenBoyDeadWithSneakers.visible = NO;
    
    mainCharacterGreenBoyHoldingUpBoxingGloveWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterGreenBoyWithSneakers10.png"];
    mainCharacterGreenBoyHoldingUpBoxingGloveWithSneakers.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterGreenBoyHoldingUpBoxingGloveWithSneakers z:25];
    mainCharacterGreenBoyHoldingUpBoxingGloveWithSneakers.position = ccp(x, y);
    mainCharacterGreenBoyHoldingUpBoxingGloveWithSneakers.visible = NO;
    
    [spriteSheetMainCharacterGreenBoyWalkingWithSneakers addChild: mainCharacterGreenBoyWalkingWithSneakers z:25];
    
    

    //Starting here, integration of Beige Girl with NO Sneakers
    //pass in the name of the property list
    //pass in the name of the property list
    [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile: @"MainCharacterBeigeGirl.plist"];
    
    //create the sprite sheet
    CCSpriteBatchNode *spriteSheetMainCharacterBeigeGirlWalking = [CCSpriteBatchNode batchNodeWithFile: @"MainCharacterBeigeGirl.png"];
    [self addChild: spriteSheetMainCharacterBeigeGirlWalking z: 150];
    
    //Create array of cairostance frames
    NSMutableArray *mainCharacterBeigeGirlWalkingAnimFrames = [NSMutableArray array];
    for(int i = 2; i <= 5; ++i) {
        [mainCharacterBeigeGirlWalkingAnimFrames addObject: [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName: [NSString stringWithFormat:@"MainCharacterBeigeGirl%d.png", i]]];
    }
    
    //Create the animation object
    CCAnimation *mainCharacterBeigeGirlWalkingAnim = [CCAnimation animationWithFrames:mainCharacterBeigeGirlWalkingAnimFrames delay:0.08f];
    
    //Create sprite and run the animation
    mainCharacterBeigeGirlWalking = [CCSprite spriteWithSpriteFrameName:@"MainCharacterBeigeGirl2.png"];
    mainCharacterBeigeGirlWalking.anchorPoint = ccp(0.5, 0.4);
    CCAction *mainCharacterBeigeGirlWalkingAction = [CCRepeatForever actionWithAction:[CCAnimate actionWithAnimation: mainCharacterBeigeGirlWalkingAnim restoreOriginalFrame:NO]];
    [mainCharacterBeigeGirlWalking runAction: mainCharacterBeigeGirlWalkingAction];
    mainCharacterBeigeGirlWalking.visible = NO;
    mainCharacterBeigeGirlWalking.position = ccp(x, y);
    
    
    mainCharacterBeigeGirlStandingStill = [CCSprite spriteWithSpriteFrameName:@"MainCharacterBeigeGirl1.png"];
    mainCharacterBeigeGirlStandingStill.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterBeigeGirlStandingStill z:25];
    mainCharacterBeigeGirlStandingStill.position = ccp(x, y);
    mainCharacterBeigeGirlStandingStill.visible = NO;
    
    mainCharacterBeigeGirlJumping = [CCSprite spriteWithSpriteFrameName:@"MainCharacterBeigeGirl9.png"];
    mainCharacterBeigeGirlJumping.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterBeigeGirlJumping z:25];
    mainCharacterBeigeGirlJumping.position = ccp(x, y);
    mainCharacterBeigeGirlJumping.visible = NO;
    
    mainCharacterBeigeGirlDead = [CCSprite spriteWithSpriteFrameName:@"MainCharacterBeigeGirl6.png"];
    mainCharacterBeigeGirlDead.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterBeigeGirlDead z:25];
    mainCharacterBeigeGirlDead.position = ccp(x, y);
    mainCharacterBeigeGirlDead.visible = NO;
    
    mainCharacterBeigeGirlHoldingUpBoxingGlove = [CCSprite spriteWithSpriteFrameName:@"MainCharacterBeigeGirl10.png"];
    mainCharacterBeigeGirlHoldingUpBoxingGlove.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterBeigeGirlHoldingUpBoxingGlove z:25];
    mainCharacterBeigeGirlHoldingUpBoxingGlove.position = ccp(x, y);
    mainCharacterBeigeGirlHoldingUpBoxingGlove.visible = NO;
    
    [spriteSheetMainCharacterBeigeGirlWalking addChild: mainCharacterBeigeGirlWalking z:25];
    
    
    
    //Starting here, integration of Beige Girl WITH Sneakers
    //pass in the name of the property list
    //pass in the name of the property list
    [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile: @"MainCharacterBeigeGirlWithSneakers.plist"];
    
    //create the sprite sheet
    CCSpriteBatchNode *spriteSheetMainCharacterBeigeGirlWalkingWithSneakers = [CCSpriteBatchNode batchNodeWithFile: @"MainCharacterBeigeGirlWithSneakers.png"];
    [self addChild: spriteSheetMainCharacterBeigeGirlWalkingWithSneakers z: 150];
    
    //Create array of cairostance frames
    NSMutableArray *mainCharacterBeigeGirlWalkingWithSneakersAnimFrames = [NSMutableArray array];
    for(int i = 2; i <= 5; ++i) {
        [mainCharacterBeigeGirlWalkingWithSneakersAnimFrames addObject: [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName: [NSString stringWithFormat:@"MainCharacterBeigeGirlWithSneakers%d.png", i]]];
    }
    
    //Create the animation object
    CCAnimation *mainCharacterBeigeGirlWithSneakersWalkingAnim = [CCAnimation animationWithFrames:mainCharacterBeigeGirlWalkingWithSneakersAnimFrames delay:0.08f];
    
    //Create sprite and run the animation
    mainCharacterBeigeGirlWalkingWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterBeigeGirlWithSneakers2.png"];
    mainCharacterBeigeGirlWalkingWithSneakers.anchorPoint = ccp(0.5, 0.4);
    CCAction *mainCharacterBeigeGirlWalkingWithSneakersAction = [CCRepeatForever actionWithAction:[CCAnimate actionWithAnimation: mainCharacterBeigeGirlWithSneakersWalkingAnim restoreOriginalFrame:NO]];
    [mainCharacterBeigeGirlWalkingWithSneakers runAction: mainCharacterBeigeGirlWalkingWithSneakersAction];
    mainCharacterBeigeGirlWalkingWithSneakers.visible = NO;
    mainCharacterBeigeGirlWalkingWithSneakers.position = ccp(x, y);
    
    
    mainCharacterBeigeGirlStandingStillWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterBeigeGirlWithSneakers1.png"];
    mainCharacterBeigeGirlStandingStillWithSneakers.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterBeigeGirlStandingStillWithSneakers z:25];
    mainCharacterBeigeGirlStandingStillWithSneakers.position = ccp(x, y);
    mainCharacterBeigeGirlStandingStillWithSneakers.visible = NO;
    
    mainCharacterBeigeGirlJumpingWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterBeigeGirlWithSneakers9.png"];
    mainCharacterBeigeGirlJumpingWithSneakers.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterBeigeGirlJumpingWithSneakers z:25];
    mainCharacterBeigeGirlJumpingWithSneakers.position = ccp(x, y);
    mainCharacterBeigeGirlJumpingWithSneakers.visible = NO;
    
    mainCharacterBeigeGirlDeadWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterBeigeGirlWithSneakers6.png"];
    mainCharacterBeigeGirlDeadWithSneakers.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterBeigeGirlDeadWithSneakers z:25];
    mainCharacterBeigeGirlDeadWithSneakers.position = ccp(x, y);
    mainCharacterBeigeGirlDeadWithSneakers.visible = NO;
    
    mainCharacterBeigeGirlHoldingUpBoxingGloveWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterBeigeGirlWithSneakers10.png"];
    mainCharacterBeigeGirlHoldingUpBoxingGloveWithSneakers.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterBeigeGirlHoldingUpBoxingGloveWithSneakers z:25];
    mainCharacterBeigeGirlHoldingUpBoxingGloveWithSneakers.position = ccp(x, y);
    mainCharacterBeigeGirlHoldingUpBoxingGloveWithSneakers.visible = NO;
    
    [spriteSheetMainCharacterBeigeGirlWalkingWithSneakers addChild: mainCharacterBeigeGirlWalkingWithSneakers z:25];
    
    
    
    
    //Starting here, integration of Purple Girl with NO Sneakers
    //pass in the name of the property list
    //pass in the name of the property list
    [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile: @"MainCharacterPurpleGirl.plist"];
    
    //create the sprite sheet
    CCSpriteBatchNode *spriteSheetMainCharacterPurpleGirlWalking = [CCSpriteBatchNode batchNodeWithFile: @"MainCharacterPurpleGirl.png"];
    [self addChild: spriteSheetMainCharacterPurpleGirlWalking z: 150];
    
    //Create array of cairostance frames
    NSMutableArray *mainCharacterPurpleGirlWalkingAnimFrames = [NSMutableArray array];
    for(int i = 2; i <= 5; ++i) {
        [mainCharacterPurpleGirlWalkingAnimFrames addObject: [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName: [NSString stringWithFormat:@"MainCharacterPurpleGirl%d.png", i]]];
    }
    
    //Create the animation object
    CCAnimation *mainCharacterPurpleGirlWalkingAnim = [CCAnimation animationWithFrames:mainCharacterPurpleGirlWalkingAnimFrames delay:0.08f];
    
    //Create sprite and run the animation
    mainCharacterPurpleGirlWalking = [CCSprite spriteWithSpriteFrameName:@"MainCharacterPurpleGirl2.png"];
    mainCharacterPurpleGirlWalking.anchorPoint = ccp(0.5, 0.4);
    CCAction *mainCharacterPurpleGirlWalkingAction = [CCRepeatForever actionWithAction:[CCAnimate actionWithAnimation: mainCharacterPurpleGirlWalkingAnim restoreOriginalFrame:NO]];
    [mainCharacterPurpleGirlWalking runAction: mainCharacterPurpleGirlWalkingAction];
    mainCharacterPurpleGirlWalking.visible = NO;
    mainCharacterPurpleGirlWalking.position = ccp(x, y);
    
    mainCharacterPurpleGirlStandingStill = [CCSprite spriteWithSpriteFrameName:@"MainCharacterPurpleGirl1.png"];
    mainCharacterPurpleGirlStandingStill.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterPurpleGirlStandingStill z:25];
    mainCharacterPurpleGirlStandingStill.position = ccp(x, y);
    mainCharacterPurpleGirlStandingStill.visible = NO;
    
    mainCharacterPurpleGirlJumping = [CCSprite spriteWithSpriteFrameName:@"MainCharacterPurpleGirl9.png"];
    mainCharacterPurpleGirlJumping.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterPurpleGirlJumping z:25];
    mainCharacterPurpleGirlJumping.position = ccp(x, y);
    mainCharacterPurpleGirlJumping.visible = NO;
    
    mainCharacterPurpleGirlDead = [CCSprite spriteWithSpriteFrameName:@"MainCharacterPurpleGirl6.png"];
    mainCharacterPurpleGirlDead.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterPurpleGirlDead z:25];
    mainCharacterPurpleGirlDead.position = ccp(x, y);
    mainCharacterPurpleGirlDead.visible = NO;
    
    mainCharacterPurpleGirlHoldingUpBoxingGlove = [CCSprite spriteWithSpriteFrameName:@"MainCharacterPurpleGirl10.png"];
    mainCharacterPurpleGirlHoldingUpBoxingGlove.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterPurpleGirlHoldingUpBoxingGlove z:25];
    mainCharacterPurpleGirlHoldingUpBoxingGlove.position = ccp(x, y);
    mainCharacterPurpleGirlHoldingUpBoxingGlove.visible = NO;
    
    [spriteSheetMainCharacterPurpleGirlWalking addChild: mainCharacterPurpleGirlWalking z:25];
    
    
    

    
    //Starting here, integration of Purple Girl WITH Sneakers
    //pass in the name of the property list
    //pass in the name of the property list
    [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile: @"MainCharacterBeigeGirlWithSneakers.plist"];
    
    //create the sprite sheet
    CCSpriteBatchNode *spriteSheetMainCharacterPurpleGirlWalkingWithSneakers = [CCSpriteBatchNode batchNodeWithFile: @"MainCharacterPurpleGirlWithSneakers.png"];
    [self addChild: spriteSheetMainCharacterPurpleGirlWalkingWithSneakers z: 150];
    
    //Create array of cairostance frames
    NSMutableArray *mainCharacterPurpleGirlWalkingWithSneakersAnimFrames = [NSMutableArray array];
    for(int i = 2; i <= 5; ++i) {
        [mainCharacterPurpleGirlWalkingWithSneakersAnimFrames addObject: [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName: [NSString stringWithFormat:@"MainCharacterPurpleGirlWithSneakers%d.png", i]]];
    }
    
    //Create the animation object
    CCAnimation *mainCharacterPurpleGirlWithSneakersWalkingAnim = [CCAnimation animationWithFrames:mainCharacterPurpleGirlWalkingWithSneakersAnimFrames delay:0.08f];
    
    //Create sprite and run the animation
    mainCharacterPurpleGirlWalkingWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterPurpleGirlWithSneakers2.png"];
    mainCharacterPurpleGirlWalkingWithSneakers.anchorPoint = ccp(0.5, 0.4);
    CCAction *mainCharacterPurpleGirlWalkingWithSneakersAction = [CCRepeatForever actionWithAction:[CCAnimate actionWithAnimation: mainCharacterPurpleGirlWithSneakersWalkingAnim restoreOriginalFrame:NO]];
    [mainCharacterPurpleGirlWalkingWithSneakers runAction: mainCharacterPurpleGirlWalkingWithSneakersAction];
    mainCharacterPurpleGirlWalkingWithSneakers.visible = NO;
    mainCharacterPurpleGirlWalkingWithSneakers.position = ccp(x, y);
    
    mainCharacterPurpleGirlStandingStillWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterPurpleGirlWithSneakers1.png"];
    mainCharacterPurpleGirlStandingStillWithSneakers.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterPurpleGirlStandingStillWithSneakers z:25];
    mainCharacterPurpleGirlStandingStillWithSneakers.position = ccp(x, y);
    mainCharacterPurpleGirlStandingStillWithSneakers.visible = NO;
    
    mainCharacterPurpleGirlJumpingWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterPurpleGirlWithSneakers9.png"];
    mainCharacterPurpleGirlJumpingWithSneakers.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterPurpleGirlJumpingWithSneakers z:25];
    mainCharacterPurpleGirlJumpingWithSneakers.position = ccp(x, y);
    mainCharacterPurpleGirlJumpingWithSneakers.visible = NO;
    
    mainCharacterPurpleGirlDeadWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterPurpleGirlWithSneakers6.png"];
    mainCharacterPurpleGirlDeadWithSneakers.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterPurpleGirlDeadWithSneakers z:25];
    mainCharacterPurpleGirlDeadWithSneakers.position = ccp(x, y);
    mainCharacterPurpleGirlDeadWithSneakers.visible = NO;
    
    mainCharacterPurpleGirlHoldingUpBoxingGloveWithSneakers = [CCSprite spriteWithSpriteFrameName:@"MainCharacterPurpleGirlWithSneakers10.png"];
    mainCharacterPurpleGirlHoldingUpBoxingGloveWithSneakers.anchorPoint = ccp(0.5, 0.4);
    [self addChild: mainCharacterPurpleGirlHoldingUpBoxingGloveWithSneakers z:25];
    mainCharacterPurpleGirlHoldingUpBoxingGloveWithSneakers.position = ccp(x, y);
    mainCharacterPurpleGirlHoldingUpBoxingGloveWithSneakers.visible = NO;
    
    [spriteSheetMainCharacterPurpleGirlWalkingWithSneakers addChild: mainCharacterPurpleGirlWalkingWithSneakers z:25];
   */ 
...
-(void) step: (ccTime) delta
{
    ...
    if (!isPaused) {
        ...
        mainCharacterGreenBoyJumping.position = firstPlayerSprite.position;
        mainCharacterGreenBoyStandingStill.position = firstPlayerSprite.position;
        mainCharacterGreenBoyWalking.position = firstPlayerSprite.position;
        mainCharacterGreenBoyDead.position = firstPlayerSprite.position;
        
        mainCharacterGreenBoyJumpingWithSneakers.position = firstPlayerSprite.position;
        mainCharacterGreenBoyStandingStillWithSneakers.position = firstPlayerSprite.position;
        mainCharacterGreenBoyWalkingWithSneakers.position = firstPlayerSprite.position;
        mainCharacterGreenBoyDeadWithSneakers.position = firstPlayerSprite.position;

        //Beige Girl, No Sneakers
        mainCharacterBeigeGirlJumping.position = firstPlayerSprite.position;
        mainCharacterBeigeGirlStandingStill.position = firstPlayerSprite.position;
        mainCharacterBeigeGirlWalking.position = firstPlayerSprite.position;
        mainCharacterBeigeGirlDead.position = firstPlayerSprite.position;
        mainCharacterBeigeGirlHoldingUpBoxingGlove.position = firstPlayerSprite.position;
        
        //Beige Girl, With Sneakers
        mainCharacterBeigeGirlJumpingWithSneakers.position = firstPlayerSprite.position;
        mainCharacterBeigeGirlStandingStillWithSneakers.position = firstPlayerSprite.position;
        mainCharacterBeigeGirlWalkingWithSneakers.position = firstPlayerSprite.position;
        mainCharacterBeigeGirlDeadWithSneakers.position = firstPlayerSprite.position;
        mainCharacterBeigeGirlHoldingUpBoxingGloveWithSneakers.position = firstPlayerSprite.position;
        
        //Purple Girl, No Sneakers
        mainCharacterPurpleGirlJumping.position = firstPlayerSprite.position;
        mainCharacterPurpleGirlStandingStill.position = firstPlayerSprite.position;
        mainCharacterPurpleGirlWalking.position = firstPlayerSprite.position;
        mainCharacterPurpleGirlDead.position = firstPlayerSprite.position;
        mainCharacterPurpleGirlHoldingUpBoxingGlove.position = firstPlayerSprite.position;
        
        //Purple Girl, With Sneakers
        mainCharacterPurpleGirlJumpingWithSneakers.position = firstPlayerSprite.position;
        mainCharacterPurpleGirlStandingStillWithSneakers.position = firstPlayerSprite.position;
        mainCharacterPurpleGirlWalkingWithSneakers.position = firstPlayerSprite.position;
        mainCharacterPurpleGirlDeadWithSneakers.position = firstPlayerSprite.position;
        mainCharacterPurpleGirlHoldingUpBoxingGlove.position = firstPlayerSprite.position;
    ...
    /*
    //Make the appropriate power-ups show up for the approrpiate levels
    if (currentLevel <= 3) {
        ...
        if (currentScreen == GAME_SCREEN) {
            ...
            stunBombPurchaseIcon.visible = NO;
            mindControllerPurchaseIcon.visible = NO;
            stunProjectilePurchaseIcon.visible = NO;
            invincibilityPowerUpPurchaseIcon.visible = NO;
            bulletTimePowerUpPurchaseIcon.visible = NO;
            globalStunPurchaseIcon.visible = NO;
            sneakerPurchaseIcon.visible = NO;
    ...
    if (currentLevel >= 4 && currentLevel < 8) {
        ...
        if (currentScreen == GAME_SCREEN) {
         ...
         //   storeButton.visible = YES;
            ...
            stunBombPurchaseIcon.visible = YES;
            mindControllerPurchaseIcon.visible = NO;
            stunProjectilePurchaseIcon.visible = NO;
            invincibilityPowerUpPurchaseIcon.visible = NO;
            bulletTimePowerUpPurchaseIcon.visible = NO;
            ...
            blueInventorySlot1.visible = YES;
            blueInventorySlot2.visible = NO;
            blueInventorySlot3.visible = NO;
            redInventorySlot4.visible = NO;
            redInventorySlot5.visible = NO;
    ...
    if (currentLevel >= 8) {
        ...
        if (currentScreen == GAME_SCREEN) {
         ...
         //   storeButton.visible = YES;
            ...
            stunBombPurchaseIcon.visible = YES;
            mindControllerPurchaseIcon.visible = YES;
            stunProjectilePurchaseIcon.visible = NO;
            invincibilityPowerUpPurchaseIcon.visible = NO;
            bulletTimePowerUpPurchaseIcon.visible = NO;
            globalStunPurchaseIcon.visible = NO;
            ...
            blueInventorySlot1.visible = YES;
            blueInventorySlot2.visible = YES;
            blueInventorySlot3.visible = NO;
            redInventorySlot4.visible = NO;
            redInventorySlot5.visible = NO;
            redInventorySlot6.visible = NO;
        ...
        if (firstPlayerJumpSpeed > 1.0) {
           ...
           //     }
                /*
                    ...
                    mainCharacterGreenBoyStandingStill.visible = NO;
                    mainCharacterGreenBoyJumping.visible = YES;
                    mainCharacterGreenBoyWalking.visible = NO;
                    mainCharacterGreenBoyDead.visible = NO;
                    mainCharacterGreenBoyHoldingUpBoxingGlove.visible = NO;
                }
                    ...
                    mainCharacterBeigeGirlStandingStill.visible = NO;
                    mainCharacterBeigeGirlJumping.visible = YES;
                    mainCharacterBeigeGirlWalking.visible = NO;
                    mainCharacterBeigeGirlDead.visible = NO;
                    mainCharacterBeigeGirlHoldingUpBoxingGlove.visible = NO;
                }
                    ...
                    mainCharacterPurpleGirlStandingStill.visible = NO;
                    mainCharacterPurpleGirlJumping.visible = YES;
                    mainCharacterPurpleGirlWalking.visible = NO;
                    mainCharacterPurpleGirlDead.visible = NO;
                    mainCharacterPurpleGirlHoldingUpBoxingGlove.visible = NO;
                }
             ...
             //   }
                /*
                    ...
                    mainCharacterGreenBoyStandingStillWithSneakers.visible = NO;
                    mainCharacterGreenBoyJumpingWithSneakers.visible = YES;
                    mainCharacterGreenBoyWalkingWithSneakers.visible = NO;
                    mainCharacterGreenBoyDeadWithSneakers.visible = NO;
                }
                    ...
                    mainCharacterBeigeGirlStandingStillWithSneakers.visible = NO;
                    mainCharacterBeigeGirlJumpingWithSneakers.visible = YES;
                    mainCharacterBeigeGirlWalkingWithSneakers.visible = NO;
                    mainCharacterBeigeGirlDeadWithSneakers.visible = NO;
                    mainCharacterBeigeGirlHoldingUpBoxingGloveWithSneakers.visible = NO;
                }
                    ...
                    mainCharacterPurpleGirlStandingStillWithSneakers.visible = NO;
                    mainCharacterPurpleGirlJumpingWithSneakers.visible = YES;
                    mainCharacterPurpleGirlWalkingWithSneakers.visible = NO;
                    mainCharacterPurpleGirlDeadWithSneakers.visible = NO;
                    mainCharacterPurpleGirlHoldingUpBoxingGloveWithSneakers.visible = NO;
                }
                            ...
                            //    if (playerColorAndGender == BLUE_BOY) {
                             ...
                             //   }
                                /*
                                    ...
                                    mainCharacterGreenBoyStandingStill.visible = YES;
                                    mainCharacterGreenBoyJumping.visible = NO;
                                    mainCharacterGreenBoyWalking.visible = NO;
                                    mainCharacterGreenBoyDead.visible = NO;
                                    mainCharacterGreenBoyHoldingUpBoxingGlove.visible = NO;
                                    ...
                                    mainCharacterBeigeGirlStandingStill.visible = YES;
                                    mainCharacterBeigeGirlJumping.visible = NO;
                                    mainCharacterBeigeGirlWalking.visible = NO;
                                    mainCharacterBeigeGirlDead.visible = NO;
                                    mainCharacterBeigeGirlHoldingUpBoxingGlove.visible = NO;
                                    ...
                                    mainCharacterPurpleGirlStandingStill.visible = YES;
                                    mainCharacterPurpleGirlJumping.visible = NO;
                                    mainCharacterPurpleGirlWalking.visible = NO;
                                    mainCharacterPurpleGirlDead.visible = NO;
                                    mainCharacterPurpleGirlHoldingUpBoxingGlove.visible = NO;
                            ...
                            //    if (playerColorAndGender == BLUE_BOY) {
                             ...
                             //   }
                                /*
                                    ...
                                    mainCharacterGreenBoyStandingStillWithSneakers.visible = YES;
                                    mainCharacterGreenBoyJumpingWithSneakers.visible = NO;
                                    mainCharacterGreenBoyWalkingWithSneakers.visible = NO;
                                    mainCharacterGreenBoyDeadWithSneakers.visible = NO;
                                    mainCharacterGreenBoyHoldingUpBoxingGlove.visible = NO;
                                    ...
                                    mainCharacterBeigeGirlStandingStillWithSneakers.visible = YES;
                                    mainCharacterBeigeGirlJumpingWithSneakers.visible = NO;
                                    mainCharacterBeigeGirlWalkingWithSneakers.visible = NO;
                                    mainCharacterBeigeGirlDeadWithSneakers.visible = NO;
                                    mainCharacterBeigeGirlHoldingUpBoxingGloveWithSneakers.visible = NO;
                                    ...
                                    mainCharacterPurpleGirlStandingStillWithSneakers.visible = YES;
                                    mainCharacterPurpleGirlJumpingWithSneakers.visible = NO;
                                    mainCharacterPurpleGirlWalkingWithSneakers.visible = NO;
                                    mainCharacterPurpleGirlDeadWithSneakers.visible = NO;
                                    mainCharacterPurpleGirlHoldingUpBoxingGloveWithSneakers.visible = NO;
       ...
       //     }
            ...
            if (moveRight1 == YES && firstPlayerCannotMoveRight == NO && firstPlayerSprite.position.y < stageTopLimitBorder && firstPlayerSprite.position.y > stageBottomLimitBorder && !firstPlayerCurrentlyDead) {
                ...
                //    }
                    /*
                        ...
                        mainCharacterGreenBoyStandingStill.visible = NO;
                        mainCharacterGreenBoyJumping.visible = NO;
                        mainCharacterGreenBoyWalking.visible = YES;
                        mainCharacterGreenBoyDead.visible = NO;
                        mainCharacterGreenBoyHoldingUpBoxingGlove.visible = NO;
                        
                        mainCharacterGreenBoyStandingStill.flipX = NO;
                        mainCharacterGreenBoyJumping.flipX = NO;
                        mainCharacterGreenBoyWalking.flipX = NO;
                        mainCharacterGreenBoyDead.flipX = NO;
                        firstPlayerSprite.flipX = NO;
                    }
                        ...
                        mainCharacterBeigeGirlStandingStill.visible = NO;
                        mainCharacterBeigeGirlJumping.visible = NO;
                        mainCharacterBeigeGirlWalking.visible = YES;
                        mainCharacterBeigeGirlDead.visible = NO;
                        mainCharacterBeigeGirlHoldingUpBoxingGlove.visible = NO;
                        
                        mainCharacterBeigeGirlStandingStill.flipX = NO;
                        mainCharacterBeigeGirlJumping.flipX = NO;
                        mainCharacterBeigeGirlWalking.flipX = NO;
                        mainCharacterBeigeGirlDead.flipX = NO;
                        mainCharacterBeigeGirlHoldingUpBoxingGlove.flipX = NO;
                        firstPlayerSprite.flipX = NO;
                    }
                        ...
                        mainCharacterPurpleGirlStandingStill.visible = NO;
                        mainCharacterPurpleGirlJumping.visible = NO;
                        mainCharacterPurpleGirlWalking.visible = YES;
                        mainCharacterPurpleGirlDead.visible = NO;
                        mainCharacterPurpleGirlHoldingUpBoxingGlove.visible = NO;
                        
                        mainCharacterPurpleGirlStandingStill.flipX = NO;
                        mainCharacterPurpleGirlJumping.flipX = NO;
                        mainCharacterPurpleGirlWalking.flipX = NO;
                        mainCharacterPurpleGirlDead.flipX = NO;
                        firstPlayerSprite.flipX = NO;
                    }
                     */
                }
                ...
                //    }
                    /*
                        ...
                        mainCharacterGreenBoyStandingStillWithSneakers.visible = NO;
                        mainCharacterGreenBoyJumpingWithSneakers.visible = NO;
                        mainCharacterGreenBoyWalkingWithSneakers.visible = YES;
                        mainCharacterGreenBoyDeadWithSneakers.visible = NO;
                        
                        mainCharacterGreenBoyStandingStillWithSneakers.flipX = NO;
                        mainCharacterGreenBoyJumpingWithSneakers.flipX = NO;
                        mainCharacterGreenBoyWalkingWithSneakers.flipX = NO;
                        mainCharacterGreenBoyDeadWithSneakers.flipX = NO;
                        firstPlayerSprite.flipX = NO;
                    }
                        ...
                        mainCharacterBeigeGirlStandingStillWithSneakers.visible = NO;
                        mainCharacterBeigeGirlJumpingWithSneakers.visible = NO;
                        mainCharacterBeigeGirlWalkingWithSneakers.visible = YES;
                        mainCharacterBeigeGirlDeadWithSneakers.visible = NO;
                        mainCharacterBeigeGirlHoldingUpBoxingGloveWithSneakers.visible = NO;
                        
                        mainCharacterBeigeGirlStandingStillWithSneakers.flipX = NO;
                        mainCharacterBeigeGirlJumpingWithSneakers.flipX = NO;
                        mainCharacterBeigeGirlWalkingWithSneakers.flipX = NO;
                        mainCharacterBeigeGirlDeadWithSneakers.flipX = NO;
                        mainCharacterBeigeGirlHoldingUpBoxingGloveWithSneakers.flipX = NO;
                        firstPlayerSprite.flipX = NO;
                    }
                        ...
                        mainCharacterPurpleGirlStandingStillWithSneakers.visible = NO;
                        mainCharacterPurpleGirlJumpingWithSneakers.visible = NO;
                        mainCharacterPurpleGirlWalkingWithSneakers.visible = YES;
                        mainCharacterPurpleGirlDeadWithSneakers.visible = NO;
                        mainCharacterPurpleGirlHoldingUpBoxingGloveWithSneakers.visible = NO;
                        
                        mainCharacterPurpleGirlStandingStillWithSneakers.flipX = NO;
                        mainCharacterPurpleGirlJumpingWithSneakers.flipX = NO;
                        mainCharacterPurpleGirlWalkingWithSneakers.flipX = NO;
                        mainCharacterPurpleGirlDeadWithSneakers.flipX = NO;
                        firstPlayerSprite.flipX = NO;
                    }
                     */
                }
            ...
            if (moveLeft1 == YES && firstPlayerCannotMoveLeft == NO && firstPlayerSprite.position.y < stageTopLimitBorder && firstPlayerSprite.position.y > stageBottomLimitBorder && !firstPlayerCurrentlyDead) {
                ...
                //    }
                    /*
                        ...
                        mainCharacterGreenBoyStandingStill.flipX = YES;
                        mainCharacterGreenBoyJumping.flipX = YES;
                        mainCharacterGreenBoyWalking.flipX = YES;
                        mainCharacterGreenBoyDead.flipX = YES;
                        mainCharacterGreenBoyHoldingUpBoxingGlove.flipX = YES;
                        firstPlayerSprite.flipX = YES;
                    }
                        ...
                        mainCharacterBeigeGirlStandingStill.flipX = YES;
                        mainCharacterBeigeGirlJumping.flipX = YES;
                        mainCharacterBeigeGirlWalking.flipX = YES;
                        mainCharacterBeigeGirlDead.flipX = YES;
                        mainCharacterBeigeGirlHoldingUpBoxingGlove.flipX = YES;
                        firstPlayerSprite.flipX = YES;
                    }
                        ...
                        mainCharacterGreenBoyWalking.flipX = YES;
                        mainCharacterGreenBoyDead.flipX = YES;
                        mainCharacterPurpleGirlHoldingUpBoxingGlove.visible = YES;
                        firstPlayerSprite.flipX = YES;
                    }
                     */
                }
               ...
               //     }
                    /*
                        ...
                        mainCharacterGreenBoyStandingStillWithSneakers.flipX = YES;
                        mainCharacterGreenBoyJumpingWithSneakers.flipX = YES;
                        mainCharacterGreenBoyWalkingWithSneakers.flipX = YES;
                        mainCharacterGreenBoyDeadWithSneakers.flipX = YES;
                        firstPlayerSprite.flipX = YES;
                    }
                        ...
                        mainCharacterBeigeGirlStandingStillWithSneakers.flipX = YES;
                        mainCharacterBeigeGirlJumpingWithSneakers.flipX = YES;
                        mainCharacterBeigeGirlWalkingWithSneakers.flipX = YES;
                        mainCharacterBeigeGirlDeadWithSneakers.flipX = YES;
                        firstPlayerSprite.flipX = YES;
                    }
                        ...
                        mainCharacterPurpleGirlStandingStillWithSneakers.flipX = YES;
                        mainCharacterPurpleGirlJumpingWithSneakers.flipX = YES;
                        mainCharacterPurpleGirlWalkingWithSneakers.flipX = YES;
                        mainCharacterPurpleGirlDeadWithSneakers.flipX = YES;
                        firstPlayerSprite.flipX = YES;
                    }
                     */
                }
        ...
        if (firstPlayerTouchingFloor == NO && !firstPlayerCurrentlyDead) {
           ...
           //     }
            ...
            if (firstPlayerHasSneakers == NO || jumpButtonTouched == YES) {
                ...
                //keep falling
                firstPlayerSprite.position = ccp(firstPlayerSprite.position.x, firstPlayerSprite.position.y - 3.0);
            }
        }
        ...
        if (levelInSession) {
            ...
            if (firstPlayerHasTimeBomb) {
                ...
                timeBomb.position = ccp(firstPlayerSprite.position.x, firstPlayerSprite.position.y + 26);
            }
            ...
            for (ExitDoor *exitDoor in exitDoorArray) {
                ...
                for (CCSprite *exitDoor in exitDoorArray) {
                    ...
                    if ((firstPlayerSprite.position.x < exitDoor.position.x + 22 && firstPlayerSprite.position.x > exitDoor.position.x - 22) && (firstPlayerSprite.position.y < exitDoor.position.y + 22 && firstPlayerSprite.position.y > exitDoor.position.y - 22) && exitDoorIsOpen == YES) {
...
-(void) decreaseTimer
{
    ...
    if (!isPaused) {
        ...
        if (timeBombPlacedOnDoor) {
            ...
            timeBomb.timeLabel.visible = YES;
            ...
            if (timeInt == MAD_AGENTS_MODE_START_TIME) {

                [self increaseMadAgentMadnessScript];
            }
            
            /*
            //If 45sec mark has been hit then make agents mad
            if (timeInt == MAD_AGENTS_MODE_START_TIME) {
            ...
            if (timeInt == 50) {
                ...
                [self addMoreDiagonalFlyerEnemySprites];
            }
...
-(void) playFastGameMusic {
    ...
    [fastGameMusic playBackgroundMusic:@"HurryUpGameMusic.mp3" loop:YES];
}
...
-(void) increaseMadAgentMadnessScript {
    ...
    if (madAgentsAmount == 0) {
        ...
        [self runAction: [CCSequence actions: [CCDelayTime actionWithDuration:0.6], [CCCallFunc actionWithTarget:self selector:@selector(playFastGameMusic)], nil]];
...
-(void) displayAllVictoryScreenInformationImmediately
{
    ...
    if (!firstPlayerHasSneakers) {
        ...
        [mainCharacterBlueBoyHoldingUpBoxingGlove runAction: [CCSequence actions: [CCDelayTime actionWithDuration:0.0], [CCMoveTo actionWithDuration:0.0 position:ccp([[CCDirector sharedDirector] winSize].width/2, [[CCDirector sharedDirector] winSize].height/2 - 100)], nil]];
        ...
        [mainCharacterBlueBoyHoldingUpBoxingGloveWithSneakers runAction: [CCSequence actions: [CCDelayTime actionWithDuration:0.0], [CCMoveTo actionWithDuration:0.0 position:ccp([[CCDirector sharedDirector] winSize].width/2, [[CCDirector sharedDirector] winSize].height/2 - 100)], nil]];
...
//  [gameMusic playBackgroundMusic:@"GameMusic.mp3" loop:YES];
...
-(void) progressToNextLevel
{
    ...
    if (currentLevel == 10 || currentLevel == 20 || currentLevel == 30 || currentLevel == 40 || currentLevel == 50 || currentLevel == 60) {
        ...
        timeLabel.position = ccp([[CCDirector sharedDirector] winSize].width/2 + 54, self.position.y - 47);
        timeLabel.visible = YES;
    ...
    if (!isBossLevel) {
        ...
        if (bossMusic != nil) {
            [bossMusic preloadBackgroundMusic:@"BossMusic.mp3"];
        ...
        [bossMusic playBackgroundMusic:@"BossMusic.mp3" loop:YES];
...
-(void) setPlayerHasInvinciblePowerUpToNo
{
    ...
    //Have player flash between red and regular several times to indicate it's about to run out
    [firstPlayerSprite runAction: [CCSequence actions: [CCTintTo actionWithDuration:0.0 red:255 green:0 blue:0], [CCDelayTime actionWithDuration:0.2], [CCTintTo actionWithDuration:0.0 red:255 green:255 blue:255], [CCDelayTime actionWithDuration:0.2], [CCTintTo actionWithDuration:0.0 red:255 green:0 blue:0], [CCDelayTime actionWithDuration:0.2], [CCTintTo actionWithDuration:0.0 red:255 green:255 blue:255], [CCDelayTime actionWithDuration:0.2], [CCTintTo actionWithDuration:0.0 red:255 green:0 blue:0], [CCDelayTime actionWithDuration:0.2], [CCTintTo actionWithDuration:0.0 red:255 green:255 blue:255], [CCDelayTime actionWithDuration:0.2], [CCTintTo actionWithDuration:0.0 red:255 green:0 blue:0], [CCDelayTime actionWithDuration:0.2], [CCTintTo actionWithDuration:0.0 red:255 green:255 blue:255], [CCCallFunc actionWithTarget:self selector:@selector(setPlayerHasInvincibilityPowerUpBooleanToNo)], nil]];
}
...
{
    NSLog (@"nuclear explosion animation should be playing");
    ...
    [solidWhiteFlashBang runAction: [CCFadeIn actionWithDuration:0.0]];
    [solidWhiteFlashBang runAction: [CCFadeOut actionWithDuration:0.4]];
    
    //Fade the tiny white oval in immediately at first
    [whiteOvalForNuclearExplosion1 runAction: [CCFadeIn actionWithDuration:0.0]];
    
    //Make white oval grow over a short time
    [whiteOvalForNuclearExplosion1 runAction: [CCScaleTo actionWithDuration:2.0 scale:5.0]];
    [whiteOvalForNuclearExplosion1 runAction: [CCFadeOut actionWithDuration:4.0]];
    ...
    [whiteOvalForNuclearExplosion1 runAction: [CCSequence actions: [CCDelayTime actionWithDuration:4.4], [CCMoveTo actionWithDuration:0.0 position:ccp(-300, -300)], [CCFadeIn actionWithDuration:0.0], [CCScaleTo actionWithDuration:0.0 scale:0.01], nil]];    
}
...
-(void) createNuclearExplosionEffectsSprites
{
    ...
    [gameLayer addChild: whiteOvalForNuclearExplosion1 z: 1000];
...
-(id) init
{
    ...
    //    [[[CCDirector sharedDirector] openGLView] addGestureRecognizer:pinchGestureRecognizer];
        ...
        */
        ...
        if (deviceIsWidescreen) {
            ...
            jumpButton.position = ccp([[CCDirector sharedDirector] winSize].width/2 + 240, [[CCDirector sharedDirector] winSize].height/2 - 170);
        ...
        if (!deviceIsWidescreen) {
            ...
            jumpButton.position = ccp([[CCDirector sharedDirector] winSize].width/2 + 240, [[CCDirector sharedDirector] winSize].height/2 - 175);
            activePowerUpButton.position = ccp([[CCDirector sharedDirector] winSize].width/2 + 130, [[CCDirector sharedDirector] winSize].height/2 - 170);
        }
      ...
      //  stunProjectileForActivePowerUpButton.opacity = 100;
        ...
        leftArrowButton.scaleX = 0.4;
        leftArrowButton.scaleY = 0.25;
        leftArrowButton.opacity = 130;
        [hudLayer addChild: leftArrowButton];
        
        //Add 'move-right' button
        rightArrowButton = [CCSprite spriteWithFile: @"RedArrow.png"];
        rightArrowButton.scaleX = 0.4;
        rightArrowButton.scaleY = 0.25;
        rightArrowButton.opacity = 130;
        ...
        if (deviceIsWidescreen) {
            ...
            leftArrowButton.position = ccp([[CCDirector sharedDirector] winSize].width/2 - 280, [[CCDirector sharedDirector] winSize].height/2 - 189);
        }
        
        if (!deviceIsWidescreen) {
            
            leftArrowButton.position = ccp([[CCDirector sharedDirector] winSize].width/2 - 230, [[CCDirector sharedDirector] winSize].height/2 - 189);
        }
        
        //Position right arrow button
        if (deviceIsWidescreen) {
            
            rightArrowButton.position = ccp([[CCDirector sharedDirector] winSize].width/2 - 180, [[CCDirector sharedDirector] winSize].height/2 - 189);
        }
        
        if (!deviceIsWidescreen) {
            
            rightArrowButton.position = ccp([[CCDirector sharedDirector] winSize].width/2 - 130, [[CCDirector sharedDirector] winSize].height/2 - 189);
        }
        ...
        */
        ...
        newGameLabel.visible = YES;
        newGameLabel.position = ccp([[CCDirector sharedDirector] winSize].width/2, [[CCDirector sharedDirector] winSize].height/2 - 60);
        ...
        deleteGameLabel.visible = YES;
        deleteGameLabel.position = ccp([[CCDirector sharedDirector] winSize].width/2 + 180, [[CCDirector sharedDirector] winSize].height/2 - 101);
        ...
        saveSlot1ForLoadScreenLabel.position = ccp([[CCDirector sharedDirector] winSize].width/2, [[CCDirector sharedDirector] winSize].height/2 + 50);
        ...
        saveSlot2ForLoadScreenLabel.position = ccp([[CCDirector sharedDirector] winSize].width/2, [[CCDirector sharedDirector] winSize].height/2 - 50);
        ...
        saveSlot3ForLoadScreenLabel.position = ccp([[CCDirector sharedDirector] winSize].width/2, [[CCDirector sharedDirector] winSize].height/2 - 150);
        ...
        loadGameLabel.visible = YES;
        loadGameLabel.position = ccp([[CCDirector sharedDirector] winSize].width/2, [[CCDirector sharedDirector] winSize].height/2 - 119);
        ...
        multiplayerGameLabel.visible = YES;
        multiplayerGameLabel.position = ccp([[CCDirector sharedDirector] winSize].width/2, [[CCDirector sharedDirector] winSize].height/2 - 180);
        ...
        hiScoreMultiplayerLabel.position = ccp([[CCDirector sharedDirector] winSize].width/2, [[CCDirector sharedDirector] winSize].height/2 + 120);
        ...
        player1Label.position = ccp([[CCDirector sharedDirector] winSize].width/2 - 160, [[CCDirector sharedDirector] winSize].height/2 + 0);
        ...
        player1ReadyLabel.position = ccp(player1Label.position.x, player1Label.position.y - 75);
        ...
        player2Label.position = ccp([[CCDirector sharedDirector] winSize].width/2 + 160, [[CCDirector sharedDirector] winSize].height/2 + 0);
        ...
        player2ReadyLabel.position = ccp(player2Label.position.x, player2Label.position.y - 75);
        ...
        versusLabel.position = ccp([[CCDirector sharedDirector] winSize].width/2, [[CCDirector sharedDirector] winSize].height/2);
        ...
        player1VersusScreeScoreLabel.position = ccp([[CCDirector sharedDirector] winSize].width/2 - 160, [[CCDirector sharedDirector] winSize].height/2 - 40);
        ...
        player2VersusScreeScoreLabel.position = ccp([[CCDirector sharedDirector] winSize].width/2 + 160, [[CCDirector sharedDirector] winSize].height/2 - 40);
        ...
        storeButton.position = ccp([[CCDirector sharedDirector] winSize].width/2, self.position.y - 22);
        storeButton.scale = 1.5;
        ...
        currentLevelLabel.position = ccp(storeButton.position.x - 55, storeButton.position.y);
    ...
    CCLabelBMFont *saveVideoButtonLabel = [CCLabelBMFont labelWithString:[NSString stringWithFormat:@"Share Game\n       Video"] fntFile:@"PixelArtFont.fnt"];
    [saveVideoButton addChild: saveVideoButtonLabel z:4000];
    saveVideoButtonLabel.scale = 0.26;
    ...
    if (gameMusic != nil) {
        [gameMusic preloadBackgroundMusic:@"GameMusic.mp3"];
      ...
      /*  if (!(CGRectContainsPoint(leftArrowButton.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(rightArrowButton.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(jumpButton.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(activePowerUpButton.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(blueInventorySlot1.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(blueInventorySlot2.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(blueInventorySlot3.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(storeButton.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(stunBombPurchaseIcon.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(mindControllerPurchaseIcon.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(sneakerPurchaseIcon.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(globalStunPurchaseIcon.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(stunProjectilePurchaseIcon.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(invincibilityPowerUpPurchaseIcon.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(bulletTimePowerUpPurchaseIcon.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(downArrowButton.boundingBox, touchLocationHudLayer)) && !(CGRectContainsPoint(mainMenuButton.boundingBox, touchLocationHudLayer))) {
        ...
        */
        ...
        if (progressToNextLevelAlreadyRunning == NO) {
            ...
            if (CGRectContainsPoint(rightArrowButton.boundingBox, touchLocationHudLayer) && !firstPlayerCurrentlyDead) {
          ...
          //  if (CGRectContainsPoint(activePowerUpButton.boundingBox, touchLocationHudLayer) && !firstPlayerCurrentlyDead) {
            ...
            /*
            else if (CGRectContainsPoint(redInventorySlot4.boundingBox, touchLocationHudLayer) && !firstPlayerCurrentlyDead && invincibilityPowerUpsLeft > 0) {
                
                //Run method which makes player have invinciblePowerUP for like 10 seconds or so]
                [self runAction: [CCSequence actions: [CCCallFunc actionWithTarget:self selector:@selector(setPlayerHasInvinciblePowerUpToYes)], [CCDelayTime actionWithDuration: 10.0], [CCCallFunc actionWithTarget:self selector:@selector(setPlayerHasInvinciblePowerUpToNo)], nil]];
            }
            
            else if (CGRectContainsPoint(redInventorySlot5.boundingBox, touchLocationHudLayer) && !firstPlayerCurrentlyDead && bulletTimePowerUpsLeft > 0) {
                
                //Run method which starts bulletTime for like 10 seconds or so
                [self runAction: [CCSequence actions: [CCCallFunc actionWithTarget:self selector:@selector(setBulletTimeActiveToYes)], [CCDelayTime actionWithDuration: 10.0], [CCCallFunc actionWithTarget:self selector:@selector(setBulletTimeActiveToNo)], nil]];
            }
            
            else if (CGRectContainsPoint(redInventorySlot6.boundingBox, touchLocationHudLayer) && !firstPlayerCurrentlyDead && globalStunPowerUpsLeft > 0) {
        ...
        if (tapToContinueLabel.visible == YES) {
...
-(void) ccTouchMoved:(UITouch *)touch withEvent:(UIEvent *)event
{
  ...
  /*
    //If player is already moving left and player moves finger off leftArrowButton then stop moving left
    if (moveLeft1) {
    ...
    //If player is already moving right and player moves finger off rightArrowButton then stop moving right
    if (moveRight1) {
...
/*
    if (currentScreen == LEVEL_SELECTION_MENU) {
        ...
        //If page1 ISNT scrolled towards page2 far enough, it snaps back to page1
        if (menuLayer.position.x >= -200 && levelSelectionMenuCurrentPage == 1) {
            
            NSLog (@"levelSelectionMenuCurrentPage = %i", levelSelectionMenuCurrentPage);
            
            levelSelectionMenuCurrentPage = 1;
            
            [menuLayer runAction: [CCMoveTo actionWithDuration:0.1 position:ccp(0,0)]];
        }
        
        //If page1 IS scrolled towards page2 far enough, it snaps to page2
        else if (menuLayer.position.x < -200 && levelSelectionMenuCurrentPage == 1) {
            
            NSLog (@"levelSelectionMenuCurrentPage = %i", levelSelectionMenuCurrentPage);
            
            levelSelectionMenuCurrentPage = 2;
            
            [menuLayer runAction: [CCMoveTo actionWithDuration:0.1 position:ccp(-610,0)]];
        }
        
        //If page2 IS scrolled towards page1 far enough, it snaps to page1
        else if (menuLayer.position.x > -400 && levelSelectionMenuCurrentPage == 2) {
        ...
        //If page2 IS scrolled towards page3 far enough, it snaps to page3
        else if (menuLayer.position.x < -800 && levelSelectionMenuCurrentPage == 2) {
            
            NSLog (@"levelSelectionMenuCurrentPage = %i", levelSelectionMenuCurrentPage);
            
            levelSelectionMenuCurrentPage = 3;
            
            [menuLayer runAction: [CCMoveTo actionWithDuration:0.1 position:ccp(-1220,0)]];
        }
        
        //If page2 ISNT scrolled towards page3 far enough, it snaps back to page2
        else if (menuLayer.position.x >= -800 && levelSelectionMenuCurrentPage == 2) {
        ...
        //If page3 IS scrolled towards page2 far enough, it snaps to page2
        else if (menuLayer.position.x > -1000 && levelSelectionMenuCurrentPage == 3) {
        ...
        //If page3 ISNT scrolled towards page2 far enough, it snaps back to page3
        else if (menuLayer.position.x <= -1000 && levelSelectionMenuCurrentPage == 3) {
 ...
 */
    /*
    if (!jumpButtonTouched || !activePowerUpButtonTouched) {
        ...
        if (!isSinglePlayer) {
            ...
            if (isPlayer1) {
                ...
                if (currentScreen == GAME_SCREEN && progressToNextLevelAlreadyRunning == NO) {
                    ...
                    player1Position = ccp(firstPlayerSprite.position.x, firstPlayerSprite.position.y);
                }
            }
            ...
            if (!isPlayer1) {
                ...
                if (currentScreen == GAME_SCREEN && progressToNextLevelAlreadyRunning == NO) {
                    ...
                    player2Position = ccp(secondPlayerSprite.position.x, secondPlayerSprite.position.y);
                }
            }
        }
    }
